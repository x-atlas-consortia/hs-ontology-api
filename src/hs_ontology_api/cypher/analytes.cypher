...
WITH CodeAnalyte,NameAnalyte,CodeModality,NameModality,CodeDatasetType,NameDatasetType,is_externally_processed,assaytypes
WHERE is_externally_processed=epictype_filter
WITH CodeAnalyte,NameAnalyte,CodeModality,NameModality,COLLECT(DISTINCT {code:CodeDatasetType, name:NameDatasetType,is_externally_processed:is_externally_processed,assaytypes:assaytypes}) AS dataset_types
WITH CodeAnalyte,NameAnalyte,COLLECT(DISTINCT {code:CodeModality, name:NameModality, dataset_types:dataset_types}) AS modalities
RETURN {analytes:COLLECT(DISTINCT {code:CodeAnalyte, name:NameAnalyte, modalities:modalities})} AS analytes

...
CALL
{
        ...
        // 2. If a criterion is an integer, assume a search on CL ID; otherwise, assume a text search on a term.
        // 3. Because the definition of a code is associated with the code's concept, there will generally be duplicate definitions per
        //    code. Take the first definition in the list.
...
// Each cell type annotation mapping:
...
// Organ list: obtain both the "organ_level" code and the corresponding UBERON organ code.

...
// Apply filters.
WITH data_type,description,alt_names,primary,dataset_provider,vis_only,contains_pii,vitessce_hints,dataset_type,dataset_active,dataset_type_active
